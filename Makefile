...
LD_FLAGS := -X github.com/xerion3800/evcc/server.Version=$(VERSION) -X github.com/xerion3800/evcc/server.Commit=$(COMMIT) -s -w
...
IMAGE_OPTIONS := -hostname evcc -http_port 8080 github.com/gokrazy/serial-busybox github.com/gokrazy/breakglass github.com/gokrazy/mkfs github.com/gokrazy/wifi github.com/xerion3800/evcc
...
docs::
	go generate github.com/xerion3800/evcc/util/templates/...
...
gokrazy::
	...
	mkdir -p env/github.com/xerion3800/evcc
	echo "EVCC_NETWORK_PORT=80" > env/github.com/xerion3800/evcc/env.txt
	echo "EVCC_DATABASE_DSN=/perm/evcc.db" >> env/github.com/xerion3800/evcc/env.txt
	mkdir -p buildflags/github.com/xerion3800/evcc
	echo "$(BUILD_TAGS),gokrazy" > buildflags/github.com/xerion3800/evcc/buildflags.txt
	echo "-ldflags=$(LD_FLAGS)" >> buildflags/github.com/xerion3800/evcc/buildflags.txt
...
soc::
	@echo Version: $(VERSION) $(SHA) $(BUILD_DATE)
	go build $(BUILD_TAGS) $(BUILD_ARGS) github.com/xerion3800/evcc/cmd/soc
