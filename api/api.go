...
//go:generate mockgen -package mock -destination ../mock/mock_api.go github.com/xerion3800/evcc/api Charger,ChargeState,PhaseSwitcher,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff
